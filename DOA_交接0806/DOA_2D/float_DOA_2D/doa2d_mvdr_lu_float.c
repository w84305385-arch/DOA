// 2D DOA Estimation - MVDR Algorithm with LU Decomposition (float)
// Original Search
//--------------------
#define PI acos(-1)
#define AVX 16
...
int search_count = 0;
//----------------------------------------------------------------
void doa2d_mvdr_lu_cpu_float_test(float *Rx_sig_re, float *Rx_sig_im, PhysicalParameters phys, RxParameters rx, TxParameters tx)
{
    //-------------------------------------------------------------------
...
int main()
{
    ...
    //=================== MVDR Algorithm =================================
    doa2d_mvdr_lu_cpu_float_test(Rx_sig_re, Rx_sig_im, phys, rx, tx);
