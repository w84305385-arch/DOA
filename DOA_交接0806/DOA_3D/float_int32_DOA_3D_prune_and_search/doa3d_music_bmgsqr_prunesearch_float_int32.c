...
int search_count = 0;
//----------------------------------------------------------------
void doa3d_music_bmgsqr_prunesearch_cpu_float_int32_test(float *Rx_sig_re, float *Rx_sig_im, PhysicalParameters phys, RxParameters rx, TxParameters tx)
{
    //-------------------------------------------------------------------
...
int main()
{
    ...
    //=================== MUSIC Algorithm =================================
    doa3d_music_bmgsqr_prunesearch_cpu_float_int32_test(Rx_sig_re, Rx_sig_im, phys, rx, tx);
