// 3D DOA Estimation - MVDR Algorithm with LU Decomposition
...
void doa3d_mvdr_lu_cpu_float_int32_test(float *Rx_sig_re, float *Rx_sig_im, PhysicalParameters phys, RxParameters rx, TxParameters tx)
{
    //-------------------------------------------------------------------
...
int main()
{
    ...
    int M = 8;
    float angle_theta[100] = { 45.0, 30, 10.0, 80.0, 70, 45, 58}; // elevation
    float angle_phi[100]    = { 0.0, 29, -35.0, 45.0, 0, 45, 58}; // azimuth
    ...
    //=================== MVDR Algorithm ==================================
    doa3d_mvdr_lu_cpu_float_int32_test(Rx_sig_re, Rx_sig_im, phys, rx, tx);
