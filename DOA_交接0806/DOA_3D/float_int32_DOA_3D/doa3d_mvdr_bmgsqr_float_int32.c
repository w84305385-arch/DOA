// 3D DOA Estimation - MVDR Algorithm with BMGS QR Decomposition
...
int search_count = 0;
//----------------------------------------------------------------
void doa3d_mvdr_bmgsqr_cpu_float_int32_test(float *Rx_sig_re, float *Rx_sig_im, PhysicalParameters phys, RxParameters rx, TxParameters tx)
{
    //-------------------------------------------------------------------
    ...
    float *De_result = (float *)malloc(Rx_M * Rx_M * sizeof(float));
    ...
    //-------------------------------------------------------------------
    // timersub function
    float time_Rxx, time_Eigen, time_Pn, time_Spatial_Spectrum, time_Peak_Search,time_MVDR;                           // create float parameter in order to convert (us) to (ms)
...
int main()
{
    ...
    int M = 8;
    float angle_theta[100] = {45.0, 30, 10.0, 60.0, 70, 45, 58}; // elevation
    float angle_phi[100]    = {0.0, 10, 35.0, 45.0, 0, 45, 58}; // azimuth
    ...
    //=================== MVDR Algorithm ==================================
    doa3d_mvdr_bmgsqr_cpu_float_int32_test(Rx_sig_re, Rx_sig_im, phys, rx, tx);
