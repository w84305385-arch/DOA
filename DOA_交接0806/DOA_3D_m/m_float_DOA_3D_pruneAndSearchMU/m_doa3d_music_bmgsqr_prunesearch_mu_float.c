...
//----------------------------------------------------------------
void m_doa3d_music_bmgsqr_pns_mu_cpu_float_test(float *Rx_sig_re, float *Rx_sig_im, PhysicalParameters phys, RxParameters rx, TxParameters tx){
    //-------------------------------------------------------------------
    ...
    //---------------------------------------------------------------
    // timersub function
    float time_initSig, time_Rxx, time_Eigen, time_Pn, time_Spatial_Spectrum, time_Peak_Search, time_MUSIC;      // create float parameter in order to convert (us) to (ms)
...
int main(){
    ...
    int M = 8;
    float angle_theta[100] = { 30, 30, 10.0, 80.0, 70, 45, 58}; // elevation
    float angle_phi[100]    = { 0, 29, -35.0, 50.0, 0, 45, 58}; // azimuth
    ...
    //=================== MUSIC Algorithm =================================
    m_doa3d_music_bmgsqr_pns_mu_cpu_float_test(Rx_sig_re, Rx_sig_im, phys, rx, tx);
