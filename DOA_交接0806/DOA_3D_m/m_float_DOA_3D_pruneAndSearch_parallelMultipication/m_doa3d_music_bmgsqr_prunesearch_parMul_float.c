...
// All Modules Utilize Parallel Matrix Multiplication
//--------------------
#define PI acos(-1)
#define AVX 16
//--------------------
...
//----------------------------------------------------------------
void m_doa3d_music_bmgsqr_pns_parMul_cpu_float_test(float *Rx_sig_re, float *Rx_sig_im, PhysicalParameters phys, RxParameters rx, TxParameters tx)
{
    //-------------------------------------------------------------------
    ...
    m_calculate_spatial_spectrum_3D_multiBeam_row_block_parallel(
        search_const, 
    ...
    m_calculate_spatial_spectrum_3D_row_block_parallel(
        search_const, 
...
int main()
{
    ...
    int M = 24;
    float angle_theta[100] = { 45, 70, 20.0, 80.0, 70, 60, 58}; // elevation
    float angle_phi[100]   = { 0, 20, -45.0, 45.0, 0, 45, 58}; // azimuth
    ...
    //=================== MUSIC Algorithm =================================
    m_doa3d_music_bmgsqr_pns_parMul_cpu_float_test(Rx_sig_re, Rx_sig_im, phys, rx, tx);
