...
//----------------------------------------------------------------
void m_doa3d_mvdr_lu_pns_parMul_cpu_float_test(float *Rx_sig_re, float *Rx_sig_im, PhysicalParameters phys, RxParameters rx, TxParameters tx)
{
    //-------------------------------------------------------------------
...
int main()
{
    ...
    //=================== MVDR Algorithm ==================================
    m_doa3d_mvdr_lu_pns_parMul_cpu_float_test(Rx_sig_re, Rx_sig_im, phys, rx, tx);
