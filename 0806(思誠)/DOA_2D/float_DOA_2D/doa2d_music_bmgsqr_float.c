...
void doa2d_music_bmgsqr_cpu_float_test(float *Rx_sig_re, float *Rx_sig_im, PhysicalParameters phys, RxParameters rx, TxParameters tx)
{
    //-------------------------------------------------------------------
    ...
    save_Spectrum_to_csv("../float_DOA_2D/data/1D_MUSIC_dB.csv", S_MUSIC_dB, search_len_theta);
    //-------------------------------------------------------------------
}
...
int main()
{
    ...
    //=================== MUSIC Algorithm =================================
    doa2d_music_bmgsqr_cpu_float_test(Rx_sig_re, Rx_sig_im, phys, rx, tx);
