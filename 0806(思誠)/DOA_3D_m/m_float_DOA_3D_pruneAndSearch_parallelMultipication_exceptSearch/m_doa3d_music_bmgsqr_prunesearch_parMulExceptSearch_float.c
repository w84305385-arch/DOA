...
//----------------------------------------------------------------
void m_doa3d_music_bmgsqr_pns_parMulExceptSearch_cpu_float_test(float *Rx_sig_re, float *Rx_sig_im, PhysicalParameters phys, RxParameters rx, TxParameters tx)
{
    //-------------------------------------------------------------------
...
int main()
{
    ...
    float angle_phi[100]    = { 0.0, 10, 36.0, 45.0, 0, 45, 58}; // azimuth
    ...
    //=================== MUSIC Algorithm =================================
    m_doa3d_music_bmgsqr_pns_parMulExceptSearch_cpu_float_test(Rx_sig_re, Rx_sig_im, phys, rx, tx);
