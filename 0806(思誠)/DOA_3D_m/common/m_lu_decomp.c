...
void m_matrix_inverse_LU(float *A_re, float *A_im, float *A_inv_re, float *A_inv_im, int N) {
    ...
    m_LU_decomposition(A_re, A_im, L_re, L_im, U_re, U_im, N);
    ...
    */
    ...
    m_complex_matrix_multiplication_row_block_parallel(U_inv_re, U_inv_im, L_inv_re, L_inv_im, A_inv_re, A_inv_im, N, N, N, num_row_blocks);
