...
void doa3d_mvdr_bmgsqr_prunesearch_cpu_float_test(float *Rx_sig_re, float *Rx_sig_im, PhysicalParameters phys, RxParameters rx, TxParameters tx)
{
    //-------------------------------------------------------------------
    ...
    if(Rx_M == 576){ // M = 576, Search 1 uses subarrays
        // Calculate Spatial Spectrum and Peak Search
    ...
    // Calculate Spatial Spectrum and Peak Search
    float *S_MVDR_dB_prune2 = (float *)malloc(search_len_theta_prune2*search_len_phi_prune2 * sizeof(float) + AVX * sizeof(float));
    calculate_spatial_spectrum_3D(
        search_const, 
    ...
    // Calculate Spatial Spectrum and Peak Search
    float *S_MVDR_dB_prune3 = (float *)malloc(search_len_theta_prune3*search_len_phi_prune3 * sizeof(float) + AVX * sizeof(float));
    calculate_spatial_spectrum_3D(
        search_const, 
    ...
    // Calculate Spatial Spectrum and Peak Search
    float *S_MVDR_dB_prune4 = (float *)malloc(search_len_theta_prune4*search_len_phi_prune4 * sizeof(float) + AVX * sizeof(float));
    calculate_spatial_spectrum_3D(
        search_const, 
    ...
    // Calculate Spatial Spectrum and Peak Search
    float *S_MVDR_dB_prune5 = (float *)malloc(search_len_theta_prune5*search_len_phi_prune5 * sizeof(float) + AVX * sizeof(float));
    calculate_spatial_spectrum_3D(
        search_const, 
...
int main()
{
    ...
    //=================== MVDR Algorithm ==================================
    doa3d_mvdr_bmgsqr_prunesearch_cpu_float_test(Rx_sig_re, Rx_sig_im, phys, rx, tx);
