...
int search_count = 0;
//----------------------------------------------------------------
void doa3d_music_bmgsqr_prunesearch_cpu_float_test(float *Rx_sig_re, float *Rx_sig_im, PhysicalParameters phys, RxParameters rx, TxParameters tx)
{
    //-------------------------------------------------------------------
...
int main()
{
    ...
    int M = 8;
    float angle_theta[100] = { 45, 45, 45.0, 15, 70, 45, 58}; // elevation
    float angle_phi[100]    = { 0, 45, -45.0, -15.0, 0, 45, 58}; // azimuth
    ...
    //=================== MUSIC Algorithm =================================
    doa3d_music_bmgsqr_prunesearch_cpu_float_test(Rx_sig_re, Rx_sig_im, phys, rx, tx);
