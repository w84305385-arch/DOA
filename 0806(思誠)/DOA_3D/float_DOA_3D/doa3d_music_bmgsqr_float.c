...
int search_count = 0;
//----------------------------------------------------------------
void doa3d_music_bmgsqr_cpu_float_test(float *Rx_sig_re, float *Rx_sig_im, PhysicalParameters phys, RxParameters rx, TxParameters tx)
{
    //-------------------------------------------------------------------
...
int main()
{
    ...
    //=================== MUSIC Algorithm =================================
    doa3d_music_bmgsqr_cpu_float_test(Rx_sig_re, Rx_sig_im, phys, rx, tx);
