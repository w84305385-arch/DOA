...
static float total_multiply_time[6] = {0};
static float total_pre_transpose_time[6] = {0};
...
int main(int argc, char **argv)
{
    ...
    float timeMusic_start[6] = {0.0};
    float timeMusic_end[6] = {0.0};

    // Total MVDR Algorithm time
    float timeMVDR_start[6] = {0.0};
    float timeMVDR_end[6] = {0.0};
    //-------------------------------------------------------------------
