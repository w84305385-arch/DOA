//將hybrid_MGS_QR_MVDR_prune.c改成int32的hybrid qr與hybrid eigen
...
// g++ -mavx512f -g -o hybrid_MGS_QR_MVDR_prune hybrid_MGS_QR_MVDR_prune.c -Wall -Wextra -std=c++14 math_func.a
// ./hybrid_MGS_QR_MVDR_prune
