// 都是float //當M>8:30度和10度是用M=8 float的MGS-QR做[0.5*lemda] ; 3、1、0.1用M float的MGS-QR[0.25*lemda]//浮點母版本
// 範圍-60~+60度，30->10->3->1->0.1 
// g++ -mavx512f -g -o float_MGS_QR_prune  float_MGS_QR_prune.c -Wall -Wextra -std=c++14 math_func.a
// ./float_MGS_QR_prune
...
int main()
{
    ...
    //-------------------------------------------------------------------
    float angle[100] = {40, 20.1, 50.6, -10, 18, 35, 45, 58}; // angle of array
    int number_angle = 1;
    int M = 4;
    int snr = 60;
    int qr_iter = 1;
