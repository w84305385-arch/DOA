//來自於prune_and_search/hybrid_MGS_QR_prune2.c
...
// g++ -mavx512f -g -o hybrid_MUSIC_prune2 hybrid_MUSIC_prune2.c -Wall -Wextra -std=c++14 math_func.a
// ./hybrid_MUSIC_prune2
...
int main()
{
    ...
    //-------------------------------------------------------------------
    float angle[100] = {5, 20.1, 50.6, -10, 18, 35, 45, 58}; // angle of array
    int number_angle = 1;
    int M = 64;
    int snr = 40;
    int qr_iter = 1;
