//來自於multi_user/hybrid_MVDR_prune.c
...
// g++ -mavx512f -g -o m_hybrid_MVDR_prune m_hybrid_MVDR_prune.c -Wall -Wextra -std=c++14 math_func.a -lpthread
// ./m_hybrid_MVDR_prune -t4
