//來自於prune_and_search/hybrid_MGS_QR_MVDR_prune.c
...
// g++ -mavx512f -g -o hybrid_MVDR_prune hybrid_MVDR_prune.c -Wall -Wextra -std=c++14 math_func.a
// ./hybrid_MVDR_prune
...
int main()
{
    ...
    //-------------------------------------------------------------------
    float angle[100] = {60, 20.1, 50.6, -10, 18, 35, 45, 58}; // angle of array
    int number_angle = 1;
    int M = 64;
    int snr = 30;
    int qr_iter = 1;
