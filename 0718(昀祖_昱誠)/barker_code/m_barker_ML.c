// g++ -mavx512f -mavx512bw -g -o m_barker_ML m_barker_ML.c -Wall -Wextra -std=c++14 math_func.a -lpthread
// ./m_barker_ML -t4
...
int main(int argc, char **argv)
{
    ...
    for(int i=0;i<127;i++){
        ...
        ML_DOA_1D_CPU(M, qr_iter, hybrid_qr_iter, &angle[0],number_angle, result, snr, &check_result);
