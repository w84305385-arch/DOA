// 都是float //當M>8:30度和10度是用M=8 float的MGS-QR做[0.5*lemda] ; 3、1、0.1用M float的MGS-QR[0.25*lemda]//MVDR的浮點母版本
// 範圍-60~+60度，30->10->3->1->0.1 
// g++ -mavx512f -g -o float_MGS_QR_MVDR_prune  float_MGS_QR_MVDR_prune.c -Wall -Wextra -std=c++14 math_func.a
// ./float_MGS_QR_MVDR_prune
