...
//等做完int32qr再來測試混合母版本的大範圍搜索可以做到幾乘幾 之前的混合母版本只能做到8x8
//範圍-60~+60度，30->10->3->1->0.1 
// g++ -mavx512f -g -o hybrid_test_peak hybrid_test_peak.c -Wall -Wextra -std=c++14 math_func.a
// ./hybrid_test_peak.c
...
int main()
{
    ...
    //-------------------------------------------------------------------
    float angle[100] = {15, 20.1, 50.6, -10, 18, 35, 45, 58}; // angle of array
    int number_angle = 1;
    int M = 64;
    int snr = 40;
    int qr_iter = 1;
