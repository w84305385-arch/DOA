//int16的加減乘尚未用AVX
//g++ -mavx512f -g -o avx512_music_mvdr_ml avx512_music_mvdr_ml.c -Wall -Wextra -std=c++14 math_func.a
//./avx512_music_mvdr_ml
#define PI acos(-1)
...
void MUSIC_DOA_2A_CPU_test(int M, int qr_iter,int hybrid_qr_iter, float *angle, int number_angle, float *result, int SNR)
{
...
void MVDR_DOA_2A_CPU_test(int M, int qr_iter, int hybrid_qr_iter, float *angle, int number_angle, float *result, int SNR)
{
...
int main()
{
    ...
    //-------------------------------------------------------------------
    float angle[100] = {20, 20.1, 50.6, -10, 18, 35, 45, 58}; // angle of array
    int number_angle = 1;
    int M = 64;
    int snr = 30;
    int qr_iter = 1;
    ...
    int iter = 1;
    //=================== MUSIC Algorithm =================================
    MUSIC_DOA_2A_CPU_test(M, qr_iter, hybrid_qr_iter, &angle[0],number_angle, result, snr);
    //=====================================================================
    //=================== MVDR Algorithm =================================
    MVDR_DOA_2A_CPU_test(M, qr_iter, hybrid_qr_iter, &angle[0],number_angle, result, snr);
    //=====================================================================
    //=================== ML Algorithm =================================
